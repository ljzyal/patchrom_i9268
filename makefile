...
local-out-zip-file := MIUI_i9268.zip

# the location for local-ota to save target-file
local-previous-target-dir := ~/workspace/ota_base/i9268_4.1

# All apps from original ZIP, but has smali files chanded
local-modified-apps := Camera SecMediaProvider FmRadio OriginalSettings
