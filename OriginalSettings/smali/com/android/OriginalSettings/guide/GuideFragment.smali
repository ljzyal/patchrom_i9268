...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/OriginalSettings/guide/GuideFragment$SettingsHeader;
    }
.end annotation
...
# instance fields
.field private mGuider:Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;

.field private mIsInGuideMode:Z

.field private mMode:Lcom/android/OriginalSettings/guide/GuideFragment$GuideModes;

.field private mOpenedHeader:Lcom/android/OriginalSettings/guide/GuideFragment$SettingsHeader;
...
.method public constructor <init>()V
    ...
    .line 48
    sget-object v0, Lcom/android/OriginalSettings/guide/GuideFragment$SettingsHeader;->NONE:Lcom/android/OriginalSettings/guide/GuideFragment$SettingsHeader;

    iput-object v0, p0, Lcom/android/OriginalSettings/guide/GuideFragment;->mOpenedHeader:Lcom/android/OriginalSettings/guide/GuideFragment$SettingsHeader;
...
.method public static deployGuide(Landroid/app/Activity;Landroid/content/Intent;)V
    ...
    .line 280
    invoke-static {p1}, Lcom/android/OriginalSettings/guide/GuideFragment;->newInstance(Landroid/content/Intent;)Lcom/android/OriginalSettings/guide/GuideFragment;
    ...
    .line 296
    sput-boolean v7, Lcom/android/OriginalSettings/guide/GuideFragment;->sIsInGuideMode:Z
    ...
    invoke-direct {v2, v4, v5}, Lcom/android/OriginalSettings/guide/GuideFragment;->initFragment(Landroid/os/Bundle;Lcom/android/OriginalSettings/guide/GuideFragment$GuideModes;)V
...
.method public static findGuideFragment(Landroid/app/Activity;)Lcom/android/OriginalSettings/guide/GuideFragmentCallback;
    .locals 2
    .parameter "activity"
...
.method private getDialogOnClickListener()Landroid/content/DialogInterface$OnClickListener;
    ...
    .prologue
    .line 714
    iget-object v0, p0, Lcom/android/OriginalSettings/guide/GuideFragment;->mGuider:Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;
...
.method private initFragment(Landroid/os/Bundle;Lcom/android/OriginalSettings/guide/GuideFragment$GuideModes;)V
    .locals 6
    ...
    .line 460
    .local v3, newMode:Lcom/android/OriginalSettings/guide/GuideFragment$GuideModes;
    if-nez v3, :cond_0
    ...
    invoke-static {p1, v4}, Lcom/android/OriginalSettings/guide/GuideModeHelper;->getGuideModeFromIntent(Landroid/os/Bundle;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p1, v4}, Lcom/android/OriginalSettings/guide/GuideModeHelper;->isInGuideMode(Landroid/os/Bundle;Landroid/os/Bundle;)Z
    ...
    .line 493
    iget-object v4, p0, Lcom/android/OriginalSettings/guide/GuideFragment;->mGuider:Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;
    ...
    invoke-interface {v4}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->onDestroy()V

    .line 495
    const/4 v4, 0x0

    iput-object v4, p0, Lcom/android/OriginalSettings/guide/GuideFragment;->mGuider:Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;
    ...
    iput-boolean v4, p0, Lcom/android/OriginalSettings/guide/GuideFragment;->mIsInGuideMode:Z

    .line 501
    sget-object v4, Lcom/android/OriginalSettings/guide/GuideFragment$1;->$SwitchMap$com$android$settings$guide$GuideFragment$GuideModes:[I

    iget-object v5, p0, Lcom/android/OriginalSettings/guide/GuideFragment;->mMode:Lcom/android/OriginalSettings/guide/GuideFragment$GuideModes;

    invoke-virtual {v5}, Lcom/android/OriginalSettings/guide/GuideFragment$GuideModes;->ordinal()I
    ...
    invoke-interface {v4}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->showHelpDialog()V

    goto :goto_1

    .line 503
    :pswitch_0
    new-instance v4, Lcom/android/OriginalSettings/guide/BtGuider;

    invoke-direct {v4, v0}, Lcom/android/OriginalSettings/guide/BtGuider;-><init>(Landroid/app/Activity;)V
    ...
    .line 507
    :pswitch_1
    new-instance v4, Lcom/android/OriginalSettings/guide/BtSettingsGuider;

    invoke-direct {v4, v0}, Lcom/android/OriginalSettings/guide/BtSettingsGuider;-><init>(Landroid/app/Activity;)V
    ...
    .line 511
    :pswitch_2
    new-instance v4, Lcom/android/OriginalSettings/guide/WifiGuider;

    invoke-direct {v4, v0}, Lcom/android/OriginalSettings/guide/WifiGuider;-><init>(Landroid/app/Activity;)V
    ...
    .line 515
    :pswitch_3
    new-instance v4, Lcom/android/OriginalSettings/guide/WifiSettingsGuider;

    invoke-direct {v4, v0}, Lcom/android/OriginalSettings/guide/WifiSettingsGuider;-><init>(Landroid/app/Activity;)V
...
.method public static isInGuideMode(Landroid/app/Activity;)Z
    ...
    invoke-static {p0}, Lcom/android/OriginalSettings/guide/GuideFragment;->findGuideFragment(Landroid/app/Activity;)Lcom/android/OriginalSettings/guide/GuideFragmentCallback;
...
.method private static newInstance(Landroid/content/Intent;)Lcom/android/OriginalSettings/guide/GuideFragment;
    .locals 3
...
.method public static onApDisableClick(Landroid/content/DialogInterface;ILandroid/app/Activity;)V
    ...
    .prologue
    .line 60
    invoke-static {p2}, Lcom/android/OriginalSettings/guide/GuideFragment;->findGuideFragment(Landroid/app/Activity;)Lcom/android/OriginalSettings/guide/GuideFragmentCallback;

    move-result-object v1

    check-cast v1, Lcom/android/OriginalSettings/guide/GuideFragment;
...
.method public static setSelectedSection(Landroid/app/Activity;Landroid/preference/PreferenceActivity$Header;)Z
    ...
    .line 86
    .local v0, guider:Lcom/android/OriginalSettings/guide/GuideFragmentCallback;
    if-eqz v0, :cond_2

    .line 87
    iget-wide v2, p1, Landroid/preference/PreferenceActivity$Header;->id:J

    invoke-interface {v0, v2, v3}, Lcom/android/OriginalSettings/guide/GuideFragmentCallback;->setSelectedSectionId(J)Z
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    .line 583
    iget-object v2, p0, Lcom/android/OriginalSettings/guide/GuideFragment;->mGuider:Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;
    ...
    invoke-interface {v2, v0, p1}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->onKey(ILandroid/view/KeyEvent;)Z
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/OriginalSettings/guide/GuideFragment;->initFragment(Landroid/os/Bundle;Lcom/android/OriginalSettings/guide/GuideFragment$GuideModes;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->onActivityCreated(Landroid/os/Bundle;)V
...
.method public onAttach(Landroid/app/Activity;)V
    ...
    .line 442
    invoke-static {p1}, Lcom/android/OriginalSettings/guide/GuideModeHelper;->init(Landroid/content/Context;)V

    .line 444
    invoke-direct {p0, v1, v1}, Lcom/android/OriginalSettings/guide/GuideFragment;->initFragment(Landroid/os/Bundle;Lcom/android/OriginalSettings/guide/GuideFragment$GuideModes;)V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->onCreate(Landroid/os/Bundle;)V
...
.method public onDestroy()V
    ...
    invoke-interface {v0}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->onDestroy()V

    .line 566
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/OriginalSettings/guide/GuideFragment;->mGuider:Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-interface {v0, p1}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->onOptionsItemSelected(Landroid/view/MenuItem;)V
...
.method public onPause()V
    ...
    invoke-interface {v0}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->onPause()V
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->onPrepareOptionsMenu(Landroid/view/Menu;)V
...
.method public onResume()V
    ...
    invoke-interface {v0}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->onResume()V
    ...
    invoke-interface {v0}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->finish()V
...
.method public setEnablers(Lcom/android/OriginalSettings/bluetooth/BluetoothEnabler;Lcom/android/OriginalSettings/wifi/WifiEnabler;)V
    ...
    iget-object v1, p0, Lcom/android/OriginalSettings/guide/GuideFragment;->mGuider:Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;
    ...
    invoke-interface {v1, v0}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->setEnabler(Lcom/android/OriginalSettings/guide/GuideFragment$WrappedEnabler;)V
    ...
    invoke-interface {v1}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->showHelpDialog()V
...
.method public setSelectedSectionId(J)Z
    ...
    .line 618
    :cond_0
    invoke-static {p1, p2}, Lcom/android/OriginalSettings/guide/GuideFragment$SettingsHeader;->fromId(J)Lcom/android/OriginalSettings/guide/GuideFragment$SettingsHeader;
    ...
    .line 620
    invoke-virtual {p0}, Lcom/android/OriginalSettings/guide/GuideFragment;->switchGuiderMode()Z
...
.method switchGuiderMode()Z
    ...
    .line 636
    .local v0, nextMode:Lcom/android/OriginalSettings/guide/GuideFragment$GuideModes;
    const/4 v1, 0x0
    ...
    .line 643
    :cond_0
    sget-object v2, Lcom/android/OriginalSettings/guide/GuideFragment$1;->$SwitchMap$com$android$settings$guide$GuideFragment$SettingsHeader:[I

    iget-object v3, p0, Lcom/android/OriginalSettings/guide/GuideFragment;->mOpenedHeader:Lcom/android/OriginalSettings/guide/GuideFragment$SettingsHeader;

    invoke-virtual {v3}, Lcom/android/OriginalSettings/guide/GuideFragment$SettingsHeader;->ordinal()I
    ...
    .line 661
    invoke-direct {p0, v4, v0}, Lcom/android/OriginalSettings/guide/GuideFragment;->initFragment(Landroid/os/Bundle;Lcom/android/OriginalSettings/guide/GuideFragment$GuideModes;)V
    ...
    invoke-interface {v2, v4}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->onCreate(Landroid/os/Bundle;)V

    .line 665
    iget-object v2, p0, Lcom/android/OriginalSettings/guide/GuideFragment;->mGuider:Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;

    invoke-interface {v2, v4}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->onActivityCreated(Landroid/os/Bundle;)V

    .line 666
    iget-object v2, p0, Lcom/android/OriginalSettings/guide/GuideFragment;->mGuider:Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;

    invoke-interface {v2}, Lcom/android/OriginalSettings/guide/GuiderLifecycleListener;->onResume()V
    ...
    .line 646
    sget-object v0, Lcom/android/OriginalSettings/guide/GuideFragment$GuideModes;->WIFI_SETTINGS:Lcom/android/OriginalSettings/guide/GuideFragment$GuideModes;
    ...
    .line 652
    sget-object v0, Lcom/android/OriginalSettings/guide/GuideFragment$GuideModes;->BLUETOOTH_SETTING:Lcom/android/OriginalSettings/guide/GuideFragment$GuideModes;
