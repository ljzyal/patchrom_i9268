...
.method constructor <init>(Landroid/content/Context;)V
    ...
    .line 48
    iput-object v7, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->context:Landroid/content/Context;

    .line 51
    iput-object v7, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->mInflater:Landroid/view/LayoutInflater;

    .line 54
    iput-object v7, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->mPackageManager:Landroid/content/pm/PackageManager;

    .line 57
    iput-object v7, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->mFontAssetManager:Landroid/content/res/AssetManager;

    .line 60
    new-instance v6, Lcom/android/OriginalSettings/flipfont/TypefaceFinder;

    invoke-direct {v6}, Lcom/android/OriginalSettings/flipfont/TypefaceFinder;-><init>()V

    iput-object v6, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->mTypefaceFinder:Lcom/android/OriginalSettings/flipfont/TypefaceFinder;
    ...
    iput-object v6, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->mFontPackageNames:Ljava/util/Vector;
    ...
    iput-object v6, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->mFontNames:Ljava/util/Vector;
    ...
    iput-object v6, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->mTypefaceFiles:Ljava/util/Vector;
    ...
    iput-object v6, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->mTypefaces:Ljava/util/Vector;

    .line 87
    iput-object v7, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->droidSansFont:Landroid/graphics/Typeface;

    .line 124
    iput-object p1, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->context:Landroid/content/Context;

    .line 125
    iget-object v6, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->mTypefaceFinder:Lcom/android/OriginalSettings/flipfont/TypefaceFinder;

    iput-object p1, v6, Lcom/android/OriginalSettings/flipfont/TypefaceFinder;->context:Landroid/content/Context;
    ...
    iput-object v6, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->mInstalledApplications:Ljava/util/List;
    ...
    .local v4, i:I
    :goto_0
    iget-object v6, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->mInstalledApplications:Ljava/util/List;
    ...
    iget-object v7, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->mFontAssetManager:Landroid/content/res/AssetManager;

    invoke-virtual {v6, v7, v3}, Lcom/android/OriginalSettings/flipfont/TypefaceFinder;->findTypefaces(Landroid/content/res/AssetManager;Ljava/lang/String;)Z
    ...
    iget-object v7, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->mPackageManager:Landroid/content/pm/PackageManager;

    iget-object v8, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->mFontNames:Ljava/util/Vector;

    iget-object v9, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->mTypefaceFiles:Ljava/util/Vector;

    iget-object v10, p0, Lcom/android/OriginalSettings/flipfont/FontListAdapter;->mFontPackageNames:Ljava/util/Vector;

    invoke-virtual {v6, v7, v8, v9, v10}, Lcom/android/OriginalSettings/flipfont/TypefaceFinder;->getSansEntries(Landroid/content/pm/PackageManager;Ljava/util/Vector;Ljava/util/Vector;Ljava/util/Vector;)V
    :try_end_0
