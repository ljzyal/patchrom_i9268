...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->CUSTOM_LIST_STATE:Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->CONTACTS_SUMMARY_PROJECTION:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->mSelectedPosition:I
    ...
    iput-object v0, p0, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->builder:Landroid/net/Uri$Builder;

    return-void
.end method

.method static synthetic access$000(Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;)I
    .locals 1
    .parameter "x0"

    .prologue
    .line 38
    iget v0, p0, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->mSelectedPosition:I

    return v0
.end method

.method static synthetic access$002(Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 38
    iput p1, p0, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->mSelectedPosition:I
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 92
    invoke-virtual {p0}, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->getListView()Landroid/widget/ListView;

    move-result-object v0

    sput-object v0, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->mlistView:Landroid/widget/ListView;

    .line 94
    sget-object v0, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->mlistView:Landroid/widget/ListView;

    invoke-virtual {p0}, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->getView()Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->mCustomListAdd:Landroid/view/View;

    .line 98
    iget-object v0, p0, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->mCustomListAdd:Landroid/view/View;
    ...
    invoke-virtual {p0}, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->getActivity()Landroid/app/Activity;
    ...
    sput-object v0, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->mAdapter_custom_list:Landroid/widget/SimpleCursorAdapter;

    .line 111
    const-string v0, "custom_list_view"

    invoke-virtual {p0, v0}, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->setCustomListState(Ljava/lang/String;)V

    .line 112
    sget-object v0, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->mlistView:Landroid/widget/ListView;

    sget-object v1, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->mAdapter_custom_list:Landroid/widget/SimpleCursorAdapter;
    ...
    new-instance v1, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList$1;

    invoke-direct {v1, p0}, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList$1;-><init>(Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;)V

    invoke-virtual {v0, v1}, Landroid/widget/ListView;->setOnItemLongClickListener(Landroid/widget/AdapterView$OnItemLongClickListener;)V

    .line 126
    invoke-virtual {p0}, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->getLoaderManager()Landroid/app/LoaderManager;
    ...
    .line 127
    invoke-virtual {p0, v8}, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->setHasOptionsMenu(Z)V
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-virtual {p0, v7}, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->setCustomListState(Ljava/lang/String;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    sget-object v2, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->mlistView:Landroid/widget/ListView;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->startActivityForResult(Landroid/content/Intent;I)V
...
.method public onCreateLoader(ILandroid/os/Bundle;)Landroid/content/Loader;
    ...
    .line 250
    iget-object v0, p0, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->builder:Landroid/net/Uri$Builder;
    ...
    sget-object v3, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->CONTACTS_SUMMARY_PROJECTION:[Ljava/lang/String;
...
.method public onLoadFinished(Landroid/content/Loader;Landroid/database/Cursor;)V
    ...
    sget-object v0, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->mAdapter_custom_list:Landroid/widget/SimpleCursorAdapter;
...
.method public bridge synthetic onLoadFinished(Landroid/content/Loader;Ljava/lang/Object;)V
    ...
    .end local p2
    invoke-virtual {p0, p1, p2}, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->onLoadFinished(Landroid/content/Loader;Landroid/database/Cursor;)V
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-static {v3}, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomListDel;->newInstance(I)Lcom/android/OriginalSettings/dormantmode/DormantModeCustomListDel;

    move-result-object v0

    .line 221
    .local v0, dmf:Lcom/android/OriginalSettings/dormantmode/DormantModeCustomListDel;
    ...
    .line 230
    .end local v0           #dmf:Lcom/android/OriginalSettings/dormantmode/DormantModeCustomListDel;
    ...
    .line 235
    invoke-virtual {p0, v2, v3}, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->startActivityForResult(Landroid/content/Intent;I)V
...
.method public onResume()V
    ...
    .line 86
    invoke-virtual {p0}, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->reloadcustomlist()V
...
.method protected setCustomListState(Ljava/lang/String;)V
    ...
    .prologue
    .line 283
    sput-object p1, Lcom/android/OriginalSettings/dormantmode/DormantModeCustomList;->CUSTOM_LIST_STATE:Ljava/lang/String;
